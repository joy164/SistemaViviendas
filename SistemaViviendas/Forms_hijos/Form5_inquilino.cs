...
{
    public partial class Form5_inquilino : Form
    {
        private Form currentChildForm;
        private Button btnActivo;

        public Form5_inquilino()
        {
            InitializeComponent();
        }
        ...
        private void btn_nuevo_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new InquilinoNuevo());
        }

        private void btn_buscar_Click(object sender, EventArgs e)
        {
            ActivarBoton(btn_buscar);
            OpenChildForm(new InquilinoBuscar());
        }

        private void btn_actualizar_Click(object sender, EventArgs e)
        {
            ActivarBoton(btn_actualizar);
            OpenChildForm(new InquilinoActualizar());
        }

        private void btn_eliminar_Click(object sender, EventArgs e)
        {
            ActivarBoton(btn_eliminar);
            OpenChildForm(new InquilinoEliminar());
        }
    }
}
